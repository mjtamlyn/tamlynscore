...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('scores_score', 'score', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Score.score'
        db.alter_column('scores_score', 'score', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'scores.score': {
            ...
            'score': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
