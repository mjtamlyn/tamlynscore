...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Score.entry'
        db.delete_column('scores_score', 'entry_id')

        # Adding field 'Score.target'
        db.add_column('scores_score', 'target', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['entries.TargetAllocation']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Score.entry'
        db.add_column('scores_score', 'entry', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['entries.SessionEntry']), keep_default=False)

        # Deleting field 'Score.target'
        db.delete_column('scores_score', 'target_id')
