...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BoundRound.use_individual_arrows'
        db.add_column('records_boundround', 'use_individual_arrows', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BoundRound.use_individual_arrows'
        db.delete_column('records_boundround', 'use_individual_arrows')
