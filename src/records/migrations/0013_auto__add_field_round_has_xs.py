...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Round.has_xs'
        db.add_column('records_round', 'has_xs', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Round.has_xs'
        db.delete_column('records_round', 'has_xs')
