...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('records_competition', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.slug'
        db.delete_column('records_competition', 'slug')
