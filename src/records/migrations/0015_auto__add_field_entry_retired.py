...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.retired'
        db.add_column('records_entry', 'retired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.retired'
        db.delete_column('records_entry', 'retired')
    ...
    models = {
        ...
        'records.entry': {
            ...
            'xs': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'records.round': {
            'Meta': {'object_name': 'Round'},
            'has_xs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
