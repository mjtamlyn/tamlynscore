...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.arrows_entered_per_end'
        db.add_column('entries_session', 'arrows_entered_per_end', self.gf('django.db.models.fields.IntegerField')(default=12), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.arrows_entered_per_end'
        db.delete_column('entries_session', 'arrows_entered_per_end')
