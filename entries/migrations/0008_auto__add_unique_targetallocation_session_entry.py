...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TargetAllocation', fields ['session_entry']
        db.create_unique('entries_targetallocation', ['session_entry_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TargetAllocation', fields ['session_entry']
        db.delete_unique('entries_targetallocation', ['session_entry_id'])
