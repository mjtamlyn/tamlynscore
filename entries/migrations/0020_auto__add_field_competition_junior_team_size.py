...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.junior_team_size'
        db.add_column(u'entries_competition', 'junior_team_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.junior_team_size'
        db.delete_column(u'entries_competition', 'junior_team_size')
    ...
    models = {
        ...
        u'entries.competition': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'junior_team_size': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
