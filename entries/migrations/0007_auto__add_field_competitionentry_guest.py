...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompetitionEntry.guest'
        db.add_column('entries_competitionentry', 'guest', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompetitionEntry.guest'
        db.delete_column('entries_competitionentry', 'guest')
