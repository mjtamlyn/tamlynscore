...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionEntry.present'
        db.add_column('entries_sessionentry', 'present', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SessionEntry.present'
        db.delete_column('entries_sessionentry', 'present')
