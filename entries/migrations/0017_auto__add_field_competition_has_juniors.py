...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.has_juniors'
        db.add_column(u'entries_competition', 'has_juniors',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.has_juniors'
        db.delete_column(u'entries_competition', 'has_juniors')
