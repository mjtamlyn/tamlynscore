...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.archers_per_target'
        db.add_column('entries_session', 'archers_per_target', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.archers_per_target'
        db.delete_column('entries_session', 'archers_per_target')
