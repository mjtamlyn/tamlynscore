...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.has_novices'
        db.add_column('entries_competition', 'has_novices',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.has_teams'
        db.add_column('entries_competition', 'has_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.novices_in_experienced_teams'
        db.add_column('entries_competition', 'novices_in_experienced_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.has_novices'
        db.delete_column('entries_competition', 'has_novices')

        # Deleting field 'Competition.has_teams'
        db.delete_column('entries_competition', 'has_teams')

        # Deleting field 'Competition.novices_in_experienced_teams'
        db.delete_column('entries_competition', 'novices_in_experienced_teams')
