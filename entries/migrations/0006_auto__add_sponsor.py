...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('entries_sponsor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('entries', ['Sponsor'])

        # Adding M2M table for field sponsors on 'Competition'
        db.create_table('entries_competition_sponsors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('competition', models.ForeignKey(orm['entries.competition'], null=False)),
            ('sponsor', models.ForeignKey(orm['entries.sponsor'], null=False))
        ))
        db.create_unique('entries_competition_sponsors', ['competition_id', 'sponsor_id'])


    def backwards(self, orm):
        
        # Deleting model 'Sponsor'
        db.delete_table('entries_sponsor')

        # Removing M2M table for field sponsors on 'Competition'
        db.delete_table('entries_competition_sponsors')
    ...
    models = {
        ...
        'entries.competition': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'sponsors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['entries.Sponsor']", 'symmetrical': 'False'}),
