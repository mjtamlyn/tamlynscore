...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionEntry.c_team'
        db.add_column('entries_competitionentry', 'c_team',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.strict_c_teams'
        db.add_column('entries_competition', 'strict_c_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionEntry.c_team'
        db.delete_column('entries_competitionentry', 'c_team')

        # Deleting field 'Competition.strict_c_teams'
        db.delete_column('entries_competition', 'strict_c_teams')
