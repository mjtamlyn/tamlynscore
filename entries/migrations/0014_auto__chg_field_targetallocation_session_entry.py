...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TargetAllocation.session_entry'
        db.alter_column('entries_targetallocation', 'session_entry_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['entries.SessionEntry'], unique=True))

    def backwards(self, orm):

        # Changing field 'TargetAllocation.session_entry'
        db.alter_column('entries_targetallocation', 'session_entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entries.SessionEntry'], unique=True))
