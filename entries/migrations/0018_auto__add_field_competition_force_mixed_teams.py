...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.force_mixed_teams'
        db.add_column(u'entries_competition', 'force_mixed_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.force_mixed_teams'
        db.delete_column(u'entries_competition', 'force_mixed_teams')
