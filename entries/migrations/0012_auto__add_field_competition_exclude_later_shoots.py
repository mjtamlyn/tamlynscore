...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.exclude_later_shoots'
        db.add_column('entries_competition', 'exclude_later_shoots',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.exclude_later_shoots'
        db.delete_column('entries_competition', 'exclude_later_shoots')
