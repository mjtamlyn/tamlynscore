...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionEntry.b_team'
        db.add_column('entries_competitionentry', 'b_team',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.strict_b_teams'
        db.add_column('entries_competition', 'strict_b_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.allow_incomplete_teams'
        db.add_column('entries_competition', 'allow_incomplete_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Competition.team_size'
        db.add_column('entries_competition', 'team_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=4),
                      keep_default=False)

        # Adding field 'Competition.novice_team_size'
        db.add_column('entries_competition', 'novice_team_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionEntry.b_team'
        db.delete_column('entries_competitionentry', 'b_team')

        # Deleting field 'Competition.strict_b_teams'
        db.delete_column('entries_competition', 'strict_b_teams')

        # Deleting field 'Competition.allow_incomplete_teams'
        db.delete_column('entries_competition', 'allow_incomplete_teams')

        # Deleting field 'Competition.team_size'
        db.delete_column('entries_competition', 'team_size')

        # Deleting field 'Competition.novice_team_size'
        db.delete_column('entries_competition', 'novice_team_size')
    ...
    models = {
        ...
        'entries.resultsmode': {
            ...
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'result_modes'", 'to': "orm['entries.Competition']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'entries.targetallocation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_entry': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['entries.SessionEntry']", 'unique': 'True'}),
