...
class OlympicInputIndex(OlympicMixin, DetailView):
    ...
    labels = ['Finals', 'Semi', '1/4', '1/8', '1/16', '1/32', '1/64']
    ...
    def get_context_data(self, **kwargs):
        ...
        context['levels'] = reversed(self.labels[:matches.max_levels[self.object]])
...
class OlympicInput(OlympicMixin, TemplateView):
    ...
    labels = ['Bronze', 'Gold', 'Semi', '1/4', '1/8', '1/16', '1/32', '1/64']
