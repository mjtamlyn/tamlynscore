...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.target_2'
        db.add_column('olympic_match', 'target_2', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.target_2'
        db.delete_column('olympic_match', 'target_2')
