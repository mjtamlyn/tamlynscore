...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Score.alteration'
        db.add_column('scores_score', 'alteration', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Score.alteration'
        db.delete_column('scores_score', 'alteration')
