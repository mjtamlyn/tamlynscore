...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Score', fields ['target']
        db.create_unique('scores_score', ['target_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Score', fields ['target']
        db.delete_unique('scores_score', ['target_id'])
    ...
    models = {
        ...
        'scores.score': {
            ...
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['entries.TargetAllocation']", 'unique': 'True'}),
