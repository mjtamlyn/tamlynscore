...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Score.target'
        db.alter_column('scores_score', 'target_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['entries.TargetAllocation'], unique=True))

    def backwards(self, orm):

        # Changing field 'Score.target'
        db.alter_column('scores_score', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entries.TargetAllocation'], unique=True))
    ...
    models = {
        ...
        'scores.dozen': {
            'Meta': {'object_name': 'Dozen'},
            'dozen': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'score': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scores.Score']"}),
        ...
        'scores.score': {
            ...
            'alteration': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'target': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['entries.TargetAllocation']", 'unique': 'True'}),
