...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scores_dozen', (
            ...
            ('dozen', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('scores', ['Dozen'])


    def backwards(self, orm):
        
        # Deleting model 'Dozen'
        db.delete_table('scores_dozen')
